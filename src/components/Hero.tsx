    ...
    <div className="relative min-h-screen flex flex-col items-center justify-center px-4">
      ...
      <div className="relative z-10 text-center space-y-8 animate-slide-up">
        ...
        <div className="pt-8">
          <Button
            onClick={onBegin}
            className="group relative px-8 py-6 text-lg font-semibold bg-card border border-cyan/30 text-foreground hover:border-cyan hover:glow-cyan transition-all duration-300"
          >
            Begin Analysis
